...
<header class="header" id="site-header">
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options active">
            ...
            ?>
            <a href="<?php echo base_url();?>admin/subject_dashboard/<?php echo base64_encode($fc_ex[0].'-'.$fc_ex[1].'-'.$fancy_row2['subject_id']);?>/"><div class="fancy-selector-option">
              <div class="fs-img">
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options">
            <?php 
                ...
                foreach($fancy_subjects as $fancy_row2):
            ?>
            <a href="<?php echo base_url();?>admin/cursos/<?php echo base64_encode($fancy_row2['class_id']);?>/"><div class="fancy-selector-option <?php if($fc_info == $fancy_row2['class_id']) echo "active";?>">
              <div class="fs-main-info">
                <div class="fs-name">
            ...
            <div class="author-page author vcard inline-items more">
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud_model->get_name('admin', $this->session->userdata('login_user_id'));?> <svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo base_url();?>style/olapp/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                    </div>
