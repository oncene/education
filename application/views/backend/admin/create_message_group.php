        ...
        <div class="chat-content text-center">
            <form class="" action="<?php echo base_url();?>admin/group/create_group/" method="post">
                ...
                <?php
                    ...
                    $user_array = ['student', 'teacher','admin','accountant'];
                    for ($i=0; $i < sizeof($user_array); $i++):
                    $user_list = $this->db->get($user_array[$i])->result_array();
                ?>
                    <div class="col-md-12" style="margin-top: 10px;">
                        <table  class="table table-bordered table-striped">
                            <h4 class="col-md-6" style="color: #000; text-align: left; padding: 0; margin: 0;"><b><?php 
                            if($user_array[$i] == 'accountant'){
                                echo 'Scretary';
                            }else{
                                echo ucfirst($user_array[$i]); 
                            }
