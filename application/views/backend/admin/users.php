                                            ...
                                            <div class="friend-item friend-groups">        
                                                <div class="friend-item-content">        
                                                  <div class="friend-avatar">
                                                      ...
                                                      <div class="author-content">
                                                        <a href="<?php echo base_url();?>admin/accountant/" class="h5 author-name"><?php echo 
														//get_phrase('accountants');
														"Secretary"
														?></a>
                                                        <div class="country">
                                                          <?php echo $this->db->count_all_results('accountant');?> <?php echo //get_phrase('accountants');
														"Secretaries"?></div>
                                                      </div>
                                                  </div>
                                                </div>
