    ...
    <div class="os-tabs-w">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper centered">
            <li class="navs-item">
                <a class="navs-links active text-center" style="" data-toggle="tab" href="#teachers"><i class="picons-thin-icon-thin-0704_users_profile_group_couple_man_woman"></i><span><?php echo get_phrase('teacher');?></span></a>
            </li>
            <li class="navs-item">
                <a class="navs-links text-center" data-toggle="tab" href="#students"><i class="picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?php echo get_phrase('student');?></span></a>
            </li>
            <!--<li class="navs-item">
    ...
    <?php echo form_open(base_url() . 'register/create_account/teacher/' , array('enctype' => 'multipart/form-data'));?>
          <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('first_name');?>" name="first_name" required="" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('last_name');?>" name="last_name" required="" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('last_name');?>" name="last_name" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
    ...
    <?php echo form_open(base_url() . 'register/create_account/parent/' , array('enctype' => 'multipart/form-data'));?>
           <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('first_name');?>" required name="first_name" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('last_name');?>" required name="last_name" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
