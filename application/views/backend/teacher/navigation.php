  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>teacher/my_routine/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo 
          ...
          <li>
          <a href="<?php echo base_url();?>teacher/grados/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('academic');?>">
            <div class="left-menu-icon">
