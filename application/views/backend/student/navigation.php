  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>student/subject/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('academic');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/my_marks/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('marks');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/class_routine/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('class_routine');?>">
            <div class="left-menu-icon">
