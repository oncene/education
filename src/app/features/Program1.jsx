...
import ProgramCard1 from '../components/common/ProgramCard1';


const Program1=()=> {
    return (
        <div className={Program1.styles.mainContainer}>
            <div className={Program1.styles.homeContainer}>  
            <div className={Program1.styles.leftBar}>
                <div className={Program1.styles.iconContainer}>
                    <img 
                    src={ICONS.SURFACE}
                    className={Program1.styles.surfaceIcon}
                    ...
                    <div style={{marginTop:'25%',marginLeft:'15%'}}>
                        ...
                        className={Program1.styles.icons}
                        />
                    </div>
                    <div style={{marginTop:'25%',marginLeft:'15%'}}>
                        <img
                    ...
                    <div>
                        <img
                        src={ICONS.LOGOUT}
                        className={Program1.styles.logout}
                        />
                    </div>
                    <div>
                        <img
                        src={ICONS.USER}
                        className={Program1.styles.user}
                        />
                    </div>
            </div>
            <div className={Program1.styles.cardMiddle}>
            ...
            <div className={Program1.styles.rightContainer}>
                <h6 style={{marginTop:"5%",marginLeft:'5%'}}>Weights</h6>
                <div className={Program1.styles.chatCollaboration}>
                    <img 
                    className={Program1.styles.chatIcon}
                    src={ICONS.WEIGHTS}
                    />
