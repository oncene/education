...
const HomeRoom2 = () => {
    return (
        <div className={HomeRoom2.styles.mainContainer}>
            <div className={HomeRoom2.styles.sidemenuComponent}>
                <SideBar />
              <MenuSideBarBig />
              <div className={HomeRoom2.styles.roomContainer}>
                  <div className={HomeRoom2.styles.innerContainer}>
                    <div className={HomeRoom2.styles.teacher}>
                        <div>
                        <img src={ICONS.AVATAR1}/>
                        </div>
                        <div style={{marginLeft:'2%'}}>
                        <p><b>Pricila Talia Vergara</b> publicó <b>Actividad del segundo parcial</b> <br />
                        <p className={HomeRoom2.styles.content}>Hace 10 minutos <br /><p className={HomeRoom2.styles.teacherRed}>DOCENTE</p></p></p>
                        </div>
                        </div>
                        <div className={HomeRoom2.styles.largeContent}>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempo incididunt ut labore et dolore magna aliqua. Ut enim ad<br />
                             ...
                             <div className={HomeRoom2.styles.progressBar}>
                                 <div className={HomeRoom2.styles.innerProgressBar}>
                                 </div>
                                 <div>Progress 4/12</div>
                                 <div>
                                 <button className={HomeRoom2.styles.PlayButton}><img src={ICONS.PLAYICON}/>Play</button>
                             </div>
                             </div>
                             
                             <div className={HomeRoom2.styles.cardInner}>
                             <div className={HomeRoom2.styles.card}>
                                 ...
                                 <div style={{marginLeft:"5%",marginTop:'2%'}}>Lorem ipsum dolor sit amet, consectetur adipisicing elit,<br />
                                      ...
                                      <p style={{marginLeft:"5%",marginTop:'10%'}}> 1.Tempo incididunt.<br /> 2.Tempo incididunt.<br /> 3.Tempo incididunt.</p>
                                       ...
                                       <div className={HomeRoom2.styles.leftRightContainer}>
