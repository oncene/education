    ...
    return (
      <Auxiliary>
        ...
        <div className="gx-sidebar-content">
          ...
          <div className="innerside2">
            <ul>
              <li className="active"> 
                  <a href="#"><img alt="" src={require("assets/images/side2.png")}/></a>
              </li>
              <li> 
                  <a href="#"><img alt="" src={require("assets/images/side3.png")}/></a>
              </li>
              <li> 
                  <a href="#"><img alt="" src={require("assets/images/side4.png")}/></a>
              </li>
              <li> 
                  <a href="#"><img alt="" src={require("assets/images/side5.png")}/></a>
              </li>
              <li> 
                  <a href="#"><img alt="" src={require("assets/images/side6.png")}/></a>
              </li>
            </ul>  
          </div>
            <Menu
